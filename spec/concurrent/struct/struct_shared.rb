shared_examples :struct do
  ...
  context 'definition' do
    ...
    it 'registers the class when given a class name' do
      ...
      expect{ described_class.const_get(clazz.to_s) }.to_not raise_error
  ...
  context 'properties' do
    ...
    context '#values_at' do
      ...
      it 'returns nil for out-of-bounds offsets in a range' do
        expect(anon_struct.values_at(9..11)).to eq [9, nil, nil]
        expect(named_struct.values_at(9..11)).to eq [9, nil, nil]
      end
