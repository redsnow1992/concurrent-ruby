...
public class SynchronizationLibrary implements Library {
    ...
    public static class JavaObject extends RubyObject {
        ...
        private volatile int anVolatileField = 0; // TODO unsed on JAVA8
        ...
        public IRubyObject getInstanceVariableVolatile(ThreadContext context, IRubyObject name) {
            int tmp;
            if (UnsafeHolder.SUPPORTS_FENCES)
        ...
        public IRubyObject getInstanceVariableVolatile(ThreadContext context, IRubyObject name, IRubyObject value) {
